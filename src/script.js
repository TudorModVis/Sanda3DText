...
rgbeLoader.load('/textures/sky.hdr', (enviromentMap) => {
...
fontLoader.load(
    ...
    (font) => {
        ...
        console.time('donuts')
        const donutGemoeetry = new THREE.ShapeGeometry( heartShape) ;

        for (let i = 0; i < 300; i++) {
            const donut = new THREE.Mesh(donutGemoeetry, material)
